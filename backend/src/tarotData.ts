...
export const MINOR_ARCANA: TarotCard[] = [
  ...
  { id: 23, name: '컵 2', name_en: 'Two of Cups', symbol: '💕', keywords_up: ['파트너십', '상호이해', '매력', '화해', '결합'], keywords_down: ['관계갈등', '이해부족', '이별', '불화'], meaning_up: '서로의 마음이 통하는 아름다운 만남이에요. 진정한 파트너십이 시작될 수 있어요.', meaning_down: '관계에서 균형이 깨졌어요. 서로의 마음을 다시 들여다볼 시간이에요.' },
  ...
  { id: 73, name: '완드 10', name_en: 'Ten of Wands', symbol: '🔥', keywords_up: ['부담', '책임과다', '무거운짐', '고군분투', '임박한해방'], keywords_down: ['짐내려놓기', '위임', '휴식', '부담해소'], meaning_up: '너무 많은 책임을 짊어지고 있어요. 무거운 짐이지만 곧 내려놓을 수 있는 끝점이 가까워요.', meaning_down: '모든 것을 혼자 하려 하지 마세요. 짐을 나누면 훨씬 가벼워질 거예요.' },
