...
exports.DAILY_PROMPT = exports.READING_PROMPT = exports.SYSTEM_PROMPT = void 0;
exports.buildReadingPrompt = buildReadingPrompt;
exports.SYSTEM_PROMPT = `너는 "타로냥"이라는 이름의 타로 점술사 고양이야.
...
마지막에 따뜻한 격려 한마디 해줘.`;
exports.DAILY_PROMPT = `## 별자리: {zodiac}
## 날짜: {date}
